"""
A python module to improve your presentation and your data
in basic python terminal programs.
...
class ColorsPalette:
    ...
    * Example:
    ...
    Finally to return the default values of your prompt, you
    should print the color.DEFAULT attribute
    """
